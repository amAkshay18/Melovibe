      ...
      body: const SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text(
              'Please read these Terms and Conditions ("Terms") carefully before using the MeloVibe application ("the App") provided by MeloVibe ("we," "us," or "our"). These Terms govern your access to and use of the App. By using the App, you agree to be bound by these Terms. If you do not agree to these Terms, please refrain from using the App.',
              style: TextStyle(
                fontSize: 18,
              ),
            ),
            ...
            SizedBox(height: 8),
            Text(
              'a. The MeloVibe App is intended for personal, non-commercial use only. You may not use the App for any unauthorized or illegal purposes.',
              style: TextStyle(
                fontSize: 18,
              ),
            ),
            ...
            SizedBox(height: 8),
            Text(
              'a. The App, including all its content, features, and functionality, is owned by MeloVibe and is protected by intellectual property laws. You may not copy, modify, distribute, transmit, display, perform, or create derivative works from any part of the App without our prior written consent.',
              style: TextStyle(
                fontSize: 18,
              ),
            ),
            Text(
              'b. The trademarks, logos, and service marks displayed within the App are the property of MeloVibe or third parties. You are prohibited from using any of these marks without our prior written permission or the permission of the respective owners.',
              style: TextStyle(
                fontSize: 18,
              ),
            ),
            ...
            Text(
              'b. In no event shall MeloVibe, its directors, officers, employees, or agents be liable for any direct, indirect, incidental, special, or consequential damages arising out of or in any way connected with the use of the App or the inability to use the App.',
              style: TextStyle(
                fontSize: 18,
              ),
            ),
            ...
            SizedBox(height: 8),
            Text(
              'a. These Terms constitute the entire agreement between you and MeloVibe regarding the use of the App and supersede any prior or contemporaneous understandings.',
              style: TextStyle(
                fontSize: 18,
              ),
            ),
