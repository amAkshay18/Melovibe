      ...
      body: const SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // SizedBox(height: 16),
            Text(
              'At MeloVibe, we are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and protect your information when you use the MeloVibe application (referred to as "the App") developed using Flutter. By using the App, you consent to the practices described in this Privacy Policy.',
            ),
            SizedBox(height: 16),
            Text(
            ...
            SizedBox(height: 8),
            Text(
              '- If we believe it is necessary to protect the rights, property, or safety of MeloVibe, our users, or others.',
            ),
            SizedBox(height: 8),
            Text(
            ...
            SizedBox(height: 16),
            Text(
              'By using the MeloVibe App, you signify your understanding and acceptance of this Privacy Policy.',
              style: TextStyle(
                fontStyle: FontStyle.italic,
              ),
            ),
